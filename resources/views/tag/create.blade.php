                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('tag.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter tag name" value="{{ old('name') }}">
                            @error('name')
